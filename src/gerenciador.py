...
# Este bloco tenta importar de duas formas para o Python não se perder
try:
    from src.configuracoes import *
    from src.entidades import Jogador, Obstaculo, Item
except ModuleNotFoundError:
    # Se der erro dizendo que não acha 'src', ele importa direto (como vizinho)
...
class GerenciadorJogo:
    def __init__(self):
        print("--- MÓDULO GERENCIADOR CARREGADO ---")
        self.fonte = pygame.font.SysFont('Arial', 30)
        
        # Carrega fundos
        self.carregar_fundos()
        
        # Reseta e cria as variáveis
        self.resetar_jogo()
    ...
    def atualizar(self):
        ...
        self.verificar_colisoes(self.game_over) # Passa estado atual se precisar (mas aqui checa interno)
    ...
    def verificar_colisoes(self, game_over_status):
        # Pequeno ajuste: game_over é self.game_over
